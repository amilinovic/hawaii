...
public class GoogleTokenIdentityVerifierTest {
    ...
    @InjectMocks
    private GoogleTokenIdentityVerifier googleTokenIdentityVerifier;

    @Test
    public void shouldReturnEmptyTokenIdentityWhenGoogleVerifierThrowsException()
